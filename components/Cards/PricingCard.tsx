...
export const PricingCard: React.FC<{ pricingCardData: PricingCardData }> = ({
    ...
    return (
        <div
            className={`relative flex flex-col items-center justify-between border-white px-[56px] py-[40px] mobile:px-[16px] ${isMostPopular ? 'border-[2px] border-opacity-100' : 'border-[1px]  border-opacity-20'}`}
        >
            {isMostPopular ? (
